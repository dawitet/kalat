...
export const shadows = {
    sm: { shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.15, shadowRadius: 2, elevation: 2, },
    md: { shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.20, shadowRadius: 4, elevation: 4, },
...
// --- Export themes ---
export const lightTheme: Theme = { colors: lightThemeColors, spacing, borderRadius, typography, shadows, };
export const darkTheme: Theme = { colors: darkThemeColors, spacing, borderRadius, typography, shadows, };
