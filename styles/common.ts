...
export const commonStyles = StyleSheet.create({
    ...
    // Shadow (iOS)
    shadowSm: { // Example small shadow
        shadowColor: '#000',
        shadowOffset: { width: 0, height: 1 },
        shadowOpacity: 0.18,
        shadowRadius: 1.0,
    },
     shadowMd: { // Example medium shadow
        shadowColor: '#000',
    ...
    borderRight: { borderRightWidth: StyleSheet.hairlineWidth, borderColor: '#ccc' },
    borderBottom: { borderBottomWidth: StyleSheet.hairlineWidth, borderColor: '#ccc' },
...
export const combineStyles = <T extends ViewStyle | TextStyle | ImageStyle>(
    ...styles: (T | false | null | undefined | StyleSheet.NamedStyles<any>[keyof StyleSheet.NamedStyles<any>])[] // Allow passing style objects directly
): T[] => { // Return array for RN style prop
