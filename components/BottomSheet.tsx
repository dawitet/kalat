...
const BottomSheet: React.FC<BottomSheetProps> = ({
    ...
    const dragHandleWrapperProps = Platform.OS === 'android' ? { ...panResponder.panHandlers } : {};
        ...
        >
            ...
            <Animated.View style={[styles.sheetContainer, { height: animatedHeight }]}>
                <DragHandleWrapper {...dragHandleWrapperProps}>
                    {showDragHandle && (
                        <View style={styles.dragHandleContainer} {...(Platform.OS === 'ios' ? panResponder.panHandlers : {})}>
                ...
                <ScrollView
                    ...
                    bounces={false}
                    {...(Platform.OS === 'android' && showDragHandle ? {} : panResponder.panHandlers)}
                >
                    {children}
                </ScrollView>
            </Animated.View>
