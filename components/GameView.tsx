...
const GameView: React.FC<GameViewProps> = ({ initialDifficulty }) => {
    ...
    const activeProgress = gameState?.currentDifficulty ? gameState.gameProgress[gameState.currentDifficulty] : null;
    ...
    const handleRevealHint = () => {
        if (!dispatch || !activeProgress || activeProgress.mainHintRevealed || activeProgress.isFinished) {
            return;
        }
    ...
    const handleNewGame = () => {
        ...
        dispatch({ type: 'START_NEW_GAME', payload: { difficulty: initialDifficulty } });
    };
    ...
    if (error) {
        return (
            <View style={[styles.errorContainer, { backgroundColor: theme.colors.primary }]}>
        ...
        <View style={[styles.container, { backgroundColor: theme.colors.primary }]}>
            ...
            <View style={styles.actionsContainer}>
                <TouchableOpacity
                    ...
                    disabled={!activeProgress || activeProgress.mainHintRevealed || activeProgress.isFinished}
                >
                    <Text style={[styles.actionButtonText, { color: theme.colors.text }]}>ፍንጭ አሳይ</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={[styles.actionButton, { backgroundColor: theme.colors.secondary }]}
                ...
                >
                    <Text style={[styles.actionButtonText, { color: theme.colors.text }]}>አዲስ ጨዋታ</Text>
                </TouchableOpacity>
            </View>
