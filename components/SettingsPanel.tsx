...
const SettingsPanel: React.FC = () => {
    ...
    const handleThemeChange = (value: ThemePreference) => {
        ...
        dispatch({ type: 'UPDATE_PREFERENCE' as any, payload: { key: 'themePreference', value: value } });
    };

    const handleHintsToggle = (value: boolean) => {
        dispatch({ type: 'UPDATE_PREFERENCE' as any, payload: { key: 'hintsEnabled', value: value } });
    };

    const handleSoundToggle = (value: boolean) => {
        dispatch({ type: 'UPDATE_PREFERENCE' as any, payload: { key: 'isMuted', value: value } });
    };

    const handleDailyReminderToggle = (value: boolean) => {
        dispatch({ type: 'UPDATE_PREFERENCE' as any, payload: { key: 'dailyReminderEnabled', value: value } });
        if (Platform.OS !== 'web') {
            if (value) {
