  ...
  ({
    ...
    const getKeyStyle = (): ViewStyle => {
      ...
      if (isSuggestion) {
        ...
        switch (state) {
          case 'correct':
            combinedStyle = {...combinedStyle, ...styles.keyCorrect};
            break;
          case 'present':
            combinedStyle = {...combinedStyle, ...styles.keyPresent};
            break;
          case 'absent':
            combinedStyle = {...combinedStyle, ...styles.keyAbsent};
            break;
          default:
            combinedStyle = {...combinedStyle, ...styles.keyDefault};
            break;
        }
      }
    ...
    return (
      <TouchableOpacity
        ...
        accessibilityHint={
          value === 'ENTER'
            ? 'Submits your current guess'
            : value === 'BACKSPACE'
            ? 'Removes the last entered letter'
            : 'Adds this letter to your guess'
        }
