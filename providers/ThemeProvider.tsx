...
import { useColorScheme, Appearance, ColorSchemeName, StatusBar, Platform } from 'react-native';
...
export const ThemeProvider: React.FC<ThemeProviderProps> = ({
    ...
    const [themePreference, setThemePreferenceState] = useState<'light' | 'dark' | 'system'>(initialPreference);
    ...
    const setThemePreference = useCallback((preference: 'light' | 'dark' | 'system') => {
    ...
    const contextValue = useMemo(() => ({
        ...
        toggleTheme,
        setThemePreference,
    }), [theme, isDark, toggleTheme, setThemePreference]); // Dependencies updated
