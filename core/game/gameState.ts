...
export const API_BASE_URL = 'https://kalat-game-backend-959ede05052d.herokuapp.com'; // Example backend URL
...
// Log initialization
console.log(`Game State Constants: WORD_LENGTH=${WORD_LENGTH}, MAX_GUESSES=${MAX_GUESSES}`);
